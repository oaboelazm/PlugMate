      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              children: [
                for (var index = 0; index < device.sockets.length; index++) ...[
                  SocketToggleTile(
                    socket: device.sockets[index],
                    onToggle: (_) => onSocketToggle(device.sockets[index]),
                  ),
                  if (index < device.sockets.length - 1) const SizedBox(height: 8),
                ],
              ],
            ),
          ],
